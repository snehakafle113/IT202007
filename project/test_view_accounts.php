...
if (isset($id)) {
   ...
   $stmt = $db->prepare("SELECT Accounts.id, user_id, account_number, account_type, balance, Users.username FROM Accounts as Accounts JOIN Users on Accounts.user_id = Users.id where Accounts.id = :id");
